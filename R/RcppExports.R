...
#' @export
emp_mode <- function(data, threshold_ = NULL, smooth = TRUE, smooth_option = "optimalOfPdf", fix_lower = NULL, fix_upper = NULL, m_degree = NULL, m_knots = NULL) {
    .Call('_modeFinder_emp_mode', PACKAGE = 'modeFinder', data, threshold_, smooth, smooth_option, fix_lower, fix_upper, m_degree, m_knots)
}
