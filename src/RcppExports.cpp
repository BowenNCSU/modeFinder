...
// emp_mode
Rcpp::List emp_mode(std::vector<double> data, Rcpp::Nullable<int> threshold_, bool smooth, String smooth_option, Rcpp::Nullable<double> fix_lower, Rcpp::Nullable<double> fix_upper, Rcpp::Nullable<int> m_degree, Rcpp::Nullable<int> m_knots);
RcppExport SEXP _modeFinder_emp_mode(SEXP dataSEXP, SEXP threshold_SEXP, SEXP smoothSEXP, SEXP smooth_optionSEXP, SEXP fix_lowerSEXP, SEXP fix_upperSEXP, SEXP m_degreeSEXP, SEXP m_knotsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<double> >::type data(dataSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<int> >::type threshold_(threshold_SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(emp_mode(data, threshold_, smooth, smooth_option, fix_lower, fix_upper, m_degree, m_knots));
